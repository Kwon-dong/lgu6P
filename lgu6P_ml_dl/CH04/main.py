...
# 개발의 관점에서 보면, 꼭 필요한 코드는 아님
# 데이터가 Age의 정보가 없을때 => 훈련데이터의 평균값을 대입해주는 코드
...
if submitted:
    ...
    # 특정한 범주에 들어갈 확률 예측 코드
    probability = model.predict_proba(processed_data)[0]  # predict_proba()함수는 확률의 값을 출력
